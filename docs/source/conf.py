...
latex_documents = [
    (master_doc, 'python-ipmi.tex', 'python-ipmi Documentation',
     'FerencFarkasPhD', 'manual'),
]
...
man_pages = [
    (master_doc, 'python-ipmi', 'python-ipmi Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'python-ipmi', 'python-ipmi Documentation',
     author, 'python-ipmi', 'One line description of project.',
     'Miscellaneous'),
]
